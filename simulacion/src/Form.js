  ...
  render() {
    ...
    return (
      <div className="main">
        ...
        <p>Si te interesa saber c&oacute;mo est&aacute;n armados, pod&eacute;s leer el paso a paso <Link to="text/prediccion-de-sueldo/index.html">aqu&iacute;</Link>.</p>
